...
BOOST_AUTO_TEST_CASE(AdvanceMarble) {
    auto m = Marble::create("1", 1 * meter, 1 * kilogram, 1 * meter, 2 * meter, 3 * meter_per_second, 4 * meter_per_second);
...
BOOST_AUTO_TEST_CASE(AdvanceMarbleByOneBigStep) {
    auto m = Marble::create("1", 0, 0, 1000000000 * meter, 0, 0.001 * meter_per_second, 0);
...
BOOST_AUTO_TEST_CASE(AdvanceSimulation) {
    auto m = Marble::create("1", 0, 0, 1 * meter, 1 * meter, 1 * meter_per_second, 1 * meter_per_second);
...
BOOST_AUTO_TEST_CASE(MarbleCollidesOnRightWall) {
    auto m = Marble::create("1", 1 * meter, 0, 1 * meter, 5 * meter, 1 * meter_per_second, 0);
    auto s = Simulation::create(10 * meter, 10 * meter, ba::list_of(m));
...
BOOST_AUTO_TEST_CASE(TwoMarblesCollideFrontalyOnHorizontalTrajectory) {
    auto m1 = Marble::create("1", 1 * meter, 1 * kilogram, 1 * meter, 5 * meter, 1 * meter_per_second, 0);
    auto m2 = Marble::create("2", 1 * meter, 1 * kilogram, 9 * meter, 5 * meter, -1 * meter_per_second, 0);
...
BOOST_AUTO_TEST_CASE(TwoMarblesCollideFrontalyOnDescendingDiagonalTrajectory) {
    auto m1 = Marble::create("1", 1 * meter, 1 * kilogram, 1 * meter, 1 * meter, 1 * meter_per_second, 1 * meter_per_second);
    auto m2 = Marble::create("2", 1 * meter, 1 * kilogram, 9 * meter, 9 * meter, -1 * meter_per_second, -1 * meter_per_second);
    auto s = Simulation::create(10 * meter, 10 * meter, ba::list_of(m1)(m2));
    s->advanceTo(3 * second);
    CHECK_CLOSE(m1->vx(), 1 * meter_per_second);
    CHECK_CLOSE(m1->vy(), 1 * meter_per_second);
...
BOOST_AUTO_TEST_CASE(TwoMarblesCollideFrontalyOnAscendingDiagonalTrajectory) {
    auto m1 = Marble::create("1", 1 * meter, 1 * kilogram, 1 * meter, 9 * meter, 1 * meter_per_second, -1 * meter_per_second);
    auto m2 = Marble::create("2", 1 * meter, 1 * kilogram, 9 * meter, 1 * meter, -1 * meter_per_second, 1 * meter_per_second);
    auto s = Simulation::create(10 * meter, 10 * meter, ba::list_of(m1)(m2));
    s->advanceTo(3 * second);
    CHECK_CLOSE(m1->vx(), 1 * meter_per_second);
    CHECK_CLOSE(m1->vy(), -1 * meter_per_second);
...
BOOST_AUTO_TEST_CASE(TwoMarblesCollideSidewayOnDiagonalTrajectories) {
    auto m1 = Marble::create("1", 1 * meter, 1 * kilogram, 1 * meter, 9 * meter, 1 * meter_per_second, -1 * meter_per_second);
    auto m2 = Marble::create("2", 1 * meter, 1 * kilogram, 1 * meter, 1 * meter, 1 * meter_per_second, 1 * meter_per_second);
    auto s = Simulation::create(10 * meter, 10 * meter, ba::list_of(m1)(m2));
    s->advanceTo(3 * second);
    CHECK_CLOSE(m1->vx(), 1 * meter_per_second);
    CHECK_CLOSE(m1->vy(), -1 * meter_per_second);
...
BOOST_AUTO_TEST_CASE(CollisionWithWallIsCanceled) {
    auto m = Marble::create("1", 1 * meter, 0, 1 * meter, 2 * meter, 1 * meter_per_second, 0);
    auto s = Simulation::create(10 * meter, 10 * meter, ba::list_of(m));
...
BOOST_AUTO_TEST_CASE(MarbleCollidesOnHorizontalWallsTwice) {
    auto m = Marble::create("1", 1 * meter, 0, 5 * meter, 1 * meter, 0, 1 * meter_per_second);
    auto s = Simulation::create(10 * meter, 10 * meter, ba::list_of(m));
    s->advanceTo(8 * second);
